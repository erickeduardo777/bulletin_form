...
function App() {
  ...
  return (
    <div className="w-full min-h-dvh bg-transparent flex justify-center items-center lg:p-10">
      {modal === false ? (
        <div className="bg-white w-dvh min-h-screen flex flex-col-reverse justify-end items-center lg:flex-row  lg:min-h-[300px] lg:max-h-[400px] lg:rounded-3xl lg:w-[75vw] landscape:min-h-screen">
